...
// Register consumers from the assembly where they are defined
builder.Services.AddMassTransit(x =>
{
    // Important: Scan the assembly where TransactionCreatedConsumer is located
    x.AddConsumers(typeof(PersonalFinance.Services.Transactions.Application.Consumers.TransactionCreatedConsumer).Assembly); 
